    ...
    <div className="container 2xl:px-20 mx-auto my-10">
      <div className="bg-gradient-to-r from-purple-800 to-purple-950 text-white py-16 text-center rounded-xl ">
        ...
        <p className="mb-8 max-w-xl mx-auto text-sm font-light px-5">
          Discover your next career move from thousands of opportunities across
          top companies and industries, and join a thriving community of job
          seekers to land your dream job today.
        </p>
      ...
      <div className="border border-gray-300 shadow-md mx-2 mt-5 p-6 rounded-md flex">
        <div className="justify-center flex flex-wrap gap-10 lg:gap-16">
