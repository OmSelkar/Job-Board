            ...
            {viewApplicationsPageData.map((applicant, index) => (
              <tr key={index} className="text-gray-700">
                ...
                <td className="px-4 py-2 border-b">
                  <a className="bg-blue-50 text-blue-400 px-3 py-1 rounded inline-flex gap-2 text-center" href="" target="_blank">
                ...
                <td className="px-4 py-2 border-b relative">
                  <div className="relative inline-block text-left group">
                    ...
                    <div className="z-10 absolute hidden left-0 right-0 top-0 mt-2 w-32 bg-white border border-gray-200 rounded shadow group-hover:block">
